...
public class HostelStudentServlet extends HttpServlet {
    ...
    // Handle POST request: Register / Update / Delete
    @Override
        ...
        try {
            switch (action) {
                case "register":
                    ...
                    // Save to database
                    boolean isSaved = dao.saveHostelStudent(newStudent);
                ...
                case "update":
                    ...
                    HostelStudent existingStudent = dao.getHostelStudent(updateId);
                    ...
                    if (existingStudent != null) {
                        ...
                        boolean isUpdated = dao.updateHostelStudent(existingStudent);
                ...
                case "delete":
                    ...
                    boolean isDeleted = dao.deleteHostelStudent(deleteId);
